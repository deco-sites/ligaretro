...
const url = 'https://ligaretro.myvtex.com/reviews-and-ratings/api';
...
export const create = async (
  ...
  const { cookie, payload } = parseCookie(req.headers, 'ligaretro');
    ...
    const response = await fetch(url + '/review', {
      ...
      headers: {
        ...
        VtexIdclientAutCookie:
          parseCookies(cookie).VtexIdclientAutCookie_ligaretro,
      },
    });
