...
function TextForm({ textSection, formTitle, apiKey }: SectionProps<ReturnType<typeof loader>>) {
    return (<div id="formFranchise" class="container grid-cols-1 md:grid-cols-2 flex flex-col a md:flex-row my-24 px-5">
      <div class="justify-center col-span-1 w-full md:w-[50%] flex md:justify-end">
        <div class="max-w-[480px] flex flex-col gap-4">
          ...
          <div class="text-sm text-left" dangerouslySetInnerHTML={{ __html: textSection.text || "" }}/>
        </div>
      </div>
