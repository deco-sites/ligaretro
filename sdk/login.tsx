const handleLoadScript = (src: string, onLoadCallback: () => void) => {
  ...
  const handleSetScope = () => {
    ...
    // @ts-expect-error
    globalThis.window.vtexid.setScope("4706efc1-4273-4c0c-8a0e-6d81bae6962f");
    // deno-lint-ignore ban-ts-comment
    // @ts-expect-error
    globalThis.window.vtexid.setScopeName("ligaretro");
  };
      ...
      `
          /*LOGIN ESTILIZADO:*/
                ...
                #vtexIdUI-global-loader {
                  ...
                  background: white url(https://ligaretro.vteximg.com.br/arquivos/loading-new.gif) no-repeat center center !important;
                ...
                button#loginWithAccessKeyBtn::after {
                  content: '';
                  display: block;
                  background: url("https://ligaretro.vteximg.com.br/arquivos/mail.png") no-repeat;
                  display: block;
                  height: 20px;
                  width: 35px;
                  position: absolute;
                ...
                .vtexIdUI #vtexIdUI-google-plus::after {
                  content: '';
                  display: block;
                  background: url("https://ligaretro.vteximg.com.br/arquivos/gplus.png") no-repeat;
                  display: block;
                  height: 30px;
                  width: 39px;
                  position: absolute;
                ...
                .vtexIdUI #vtexIdUI-facebook::after {
                  content: '';
                  display: block;
                  background: url("https://ligaretro.vteximg.com.br/arquivos/facebookicon.png") no-repeat;
                  display: block;
                  height: 30px;
                  width: 30px;
                  position: absolute;
                ...
                button#loginWithUserAndPasswordBtn::after {
                  content: '';
                  display: block;
                  background: url("https://ligaretro.vteximg.com.br/arquivos/lock.png") no-repeat;
                  height: 30px;
                  width: 39px;
                  position: absolute;
                  top: 21%;
                ...
                .vtexIdUI-back-link .vtexid-icon-arrow-left {
                  color: grey;
                  background: url(https://ligaretro.vteximg.com.br/arquivos/arrow-left.png) no-repeat;
